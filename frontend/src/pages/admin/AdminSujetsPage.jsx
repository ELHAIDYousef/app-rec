...
function SujetForm({ sujet, onSave, onCancel }) {
    ...
    <div className="card" style={{ maxWidth: 640, marginBottom: 20 }}>
      ...
      <form onSubmit={save}>
        ...
        <div className="field">
          ...
          <input className="field-input" value={form.encadrant} placeholder="Nom de l'encadrant"
            onChange={e => setForm(f => ({ ...f, encadrant: e.target.value }))} />
        </div>
