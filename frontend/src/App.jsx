...
// ── Pages Encadrant ────────────────────────────────────────────
import MesStagiaires    from "pages/encadrant/MesStagiaires";
import MesSujets        from "pages/encadrant/MesSujets";
import StagiaireDetail  from "pages/encadrant/StagiaireDetail";

const ALL_ROLES = ["candidat", "rh", "admin", "stagiaire", "encadrant"];
...
function ATSRoutes() {
  ...
  return (
    <Routes>
      ...
      {/* Encadrant */}
      <Route path="/encadrant/stagiaires"     element={<Layout roles={["encadrant"]}><MesStagiaires/></Layout>}/>
      <Route path="/encadrant/sujets"         element={<Layout roles={["encadrant"]}><MesSujets/></Layout>}/>
      <Route path="/encadrant/stagiaire/:id"  element={<Layout roles={["encadrant"]}><StagiaireDetail/></Layout>}/>
